    ...
    <div class="page-wrapper">
       ...
       <?php include "content-left-menu.php"?>
        ...
        if(@$_GET['page'] == "member"){
            ...
            include "view/master/suplier.php";
        }
            ...
            include "view/pengaturan/ubah-pass.php";
        }
        else{
            include "content-dashboard.php";
        }
...
jika sebuah variabel atau parameter GET(tampil di browser) dengan nama page  
bernilai soal-uts, maka akan menjalankan perintah
@ digunakan untuk menghilangkan pesan error
           
 include "view/soal-uts.php";
 menyisipkan file soal-uts.php y7ang berada di dalam folder view
