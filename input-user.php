					...
					<div class="modal-content">
						...
						<div class="modal-body">
                                        ...
                                        <form action="" method="post" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="nama_user" class=" form-control-label">Nama_user</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="nama_user" name="nama_user" placeholder="" class="form-control">
                                                    <span class="help-block text-danger validasi-nama">Nama user belum diisi</span>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="lev-user" class=" form-control-label">Lev.User</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                   <select class="form-control" id="lev_user" name="id_user">
                                                       <option value="">-- Pilih --</option>
                                                       <option value="administrator">Administrtor</option>
                                                       <option value="kasir">Kasir</option>
                                                   </select>
                                                    <span class="help-block text-danger validasi-lev-user">Level user belum diisi</span>
                                                </div>
                                            </div>
